...
class SegmentTree7 {
    ...
    SegmentTree7(int player_num, size_t size, size_t d) : oram(player_num, size), leftChildSibling(player_num, size), rightChildSibling(player_num, size), parent(player_num, size) {
            num_items = size;
            depth = d;
