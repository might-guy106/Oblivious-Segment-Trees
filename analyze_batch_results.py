...
def plot_results(data):
    ...
    def annotate_points(x_vals, y_vals, ax=None):
        ...
        for x, y in zip(x_vals, y_vals):
            target.annotate(f"{y:.1f}", (x, y), textcoords="offset points", xytext=(0,5), ha='center', fontsize=8,
    ...
    console.print("[green]Plots saved: update_breakdown.png, query_breakdown.png, update_comparison.png, query_comparison.png[/green]")
