...
SRCS=prac.cpp mpcio.cpp preproc.cpp online.cpp mpcops.cpp rdpf.cpp \
	...
	heapsampler.cpp segmentTree.cpp segmentTree2.cpp segmentTree3.cpp segmentTree4.cpp segmentTree5.cpp segmentTree6.cpp segmentTree7.cpp segmentTreeClean.cpp test_custompath.cpp
OBJS=$(SRCS:.cpp=.o) 
ASMS=$(SRCS:.cpp=.s)
