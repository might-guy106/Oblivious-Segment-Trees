...
```bash
./prac -o -t <threads> <player> [addresses] segmenttree9 -d <depth> -u <updates> -q <queries>
```
...
**Terminal 1 (Player 0):**
```bash
./prac -o -t 8 0 segmenttree9 -d 4 -u 3 -q 5
```

**Terminal 2 (Player 1):**
```bash
./prac -o -t 8 1 localhost segmenttree9 -d 4 -u 3 -q 5
```

**Terminal 3 (Player 2 - Server):**
```bash
./prac -o -t 8 2 localhost localhost segmenttree9 -d 4 -u 3 -q 5
```
...
**Terminal 1 (Player 0):**
```bash
./prac -t 8 0 segmenttree9 -d 20 -u 10 -q 10
```

**Terminal 2 (Player 1):**
```bash
./prac -t 8 1 localhost segmenttree9 -d 20 -u 10 -q 10
```

**Terminal 3 (Player 2):**
```bash
./prac -t 8 2 localhost localhost segmenttree9 -d 20 -u 10 -q 10
```
...
```bash
./run_experiment_tmux.sh 20 5 5 segmenttree9 8
```
